...
class Company < ApplicationRecord
  ...
  has_many :capture_records,
           class_name: "TrnCaptureRecord",
           foreign_key: :company_code,
           primary_key: :code,
           inverse_of: :company

  has_many :journal_entry_patterns,
           class_name: "JournalEntryPattern",
           foreign_key: :company_code,
           primary_key: :code,
           inverse_of: :company

  has_many :journal_entry_records,
           class_name: "TrnJournalEntryRecord",
           foreign_key: :company_code,
           primary_key: :code,
           inverse_of: :company
